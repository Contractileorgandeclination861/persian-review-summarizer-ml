...
_PERSIAN_STOPWORDS = {
    ...
    # واژه‌های پرتکرار بی‌محتوا (برای بهبود کیفیت کلیدواژه)
    "داره", "دارم", "دارن", "چون", "کمی", "اصلا", "اصلاً", "واقعا", "واقعاً",
    "دیگه", "یعنی", "الان", "حالا", "چند", "بار", "کل", "بهش", "اون", "منم",
    "میشه", "می‌شه", "میشود", "می‌شود", "شود", "نبود", "بودم", "هستم", "نمیشه",
    "نظر", "نظرم", "کنه", "می‌کنه", "میکنه", "شدم", "باشه", "بشه", "تونه",
    "همین", "اینکه", "چیزی", "خیلیم", "بعد", "قبل", "طور", "چطور",
}
